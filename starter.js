...
const calculator = (num1, num2, cb) => {
  if(+num1 && +num2){
    ...
    return 'Please only submit numbers'
  }
}

// console.log(calculator(2, '12', divide))
...
const colorsMap = (element) => {
  return 'pink'
}

const mappedColors = colors.map(colorsMap)

// console.log(colors, mappedColors)
...
const placesThatStartWithA = places.filter((place, i) => {
  // console.log(place.startsWith('A'), place)
